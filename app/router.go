...
func NewRouter(userController controller.UserController, categoryController controller.CategoryController, articleController controller.ArticleController) *httprouter.Router {
